...
const options = {
    definition: {
        openapi: '3.0.0',
        info: {
            title: 'API Candies Shop',
            version: '0.1',
            description: 'Une simple API pour acheter des confiseries',
            license: {
                name: 'MIT',
...
function init () {
    ...
    candiesRoutes.use('/api-docs', swaggerUi.serve)
    candiesRoutes.get('/api-docs', swaggerUi.setup(specs))
