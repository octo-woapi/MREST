...
public class FormuleController {
  ...
  public FormuleController(
      FormuleApiMapper formuleApiMapper,
      RecupererUneFormule recupererUneFormule,
      RecupererToutesLesFormules recupererToutesLesFormules,
      CreerUneFormule creerUneFormule,
      ModifierLePrixDuneFormule modifierLePrixDuneFormule) {
    this.formuleApiMapper = formuleApiMapper;
    this.recupererUneFormule = recupererUneFormule;
    this.recupererToutesLesFormules = recupererToutesLesFormules;
    this.creerUneFormule = creerUneFormule;
    this.modifierLePrixDuneFormule = modifierLePrixDuneFormule;
  }
